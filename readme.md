...
In principle you clone the project of [API_CARVAJAL_MC](https://github.com/ANGELcr95/API_CARVAJAL_MC), you go to your code editor and clone it previously having installed GIT as the following command (git clone url)
...
For the cloudinary key you go to the following portal [url](https://cloudinary.com/) creating a free user will generate the keys
...
Currently the API is in production, you can consult it [API](https://apicarvajalmc-production.up.railway.app)
Or from the same API [api-doc](https://apicarvajalmc-production.up.railway.app/api-doc/)
Diagram UML [MODEL-UML](https://drive.google.com/file/d/1kzfUNTlb3LnasTaE6R63Uy4PxpHXuJEm/view?usp=sharing)
